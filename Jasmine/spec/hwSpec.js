...
describe("Sum1toN", function () {
  ...
  it("retornar 1 cunado pasamos 1 como argumento", function () {
...
describe("sumFirstLast", function () {
  ...
  it("retorna 15 cuando pasamos [1,3,14] como argumento", function () {
    expect(sumFirstLast([1, 3, 14])).toEqual(15);
  });
});
describe("sumMaxMin", function () {
  it("retorna 11 cuando pasamos [1,3,10] como argumento", function () {
    expect(sumMaxMin([1, 3, 10])).toEqual(11);
  });
  it("retorna -12 cuando pasamos [-2,-5,-10] como argumento", function () {
